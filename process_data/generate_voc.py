...
dirname = "Clothing"
f_train = open("../dataset/{}/local_train_sample_sorted_by_time".format(dirname), "r")
uid_dict = {}
mid_dict = {}
cat_dict = {}
...
cPickle.dump(uid_voc, open("../dataset/{}/uid_voc.pkl".format(dirname), "w"))
cPickle.dump(mid_voc, open("../dataset/{}/mid_voc.pkl".format(dirname), "w"))
cPickle.dump(cat_voc, open("../dataset/{}/cat_voc.pkl".format(dirname), "w"))

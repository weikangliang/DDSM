...
def get_cut_time(percent=0.85):
    time_list = []
    fin = open("../dataset/Beauty/local_all_sample_sorted_by_time2", "r")
    for line in fin:
        line = line.strip()
...
def split_test_by_item_users():
    fin = open("../dataset/Beauty/local_test_sample_sorted_by_time", "r")
    ftest0 = open("../dataset/Beauty/local_test_sample_sorted_by_time_0", "w")
    ftest10 = open("../dataset/Beauty/local_test_sample_sorted_by_time_1to9", "w")
    ftest20 = open("../dataset/Beauty/local_test_sample_sorted_by_time_10to19", "w")
    ftest30 = open("../dataset/Beauty/local_test_sample_sorted_by_time_20to29", "w")
    ftest40 = open("../dataset/Beauty/local_test_sample_sorted_by_time_30to39", "w")
    ftest41 = open("../dataset/Beauty/local_test_sample_sorted_by_time_40", "w")
    for line in fin:
        line = line.strip()
...
def split_test_by_users():
    fin = open("../dataset/Beauty/local_test_sample_sorted_by_time", "r")
    ftest5 = open("../dataset/Beauty/local_test_split_by_user_1to5", "w")
    ftest10 = open("../dataset/Beauty/local_test_split_by_user_6to10", "w")
    ftest15 = open("../dataset/Beauty/local_test_split_by_user_11to15", "w")
    ftest20 = open("../dataset/Beauty/local_test_split_by_user_16to20", "w")
    for line in fin:
        line = line.strip()
...
def split_test_by_time(cut_time):
    fin = open("../dataset/Beauty/local_all_sample_sorted_by_time2", "r")
    ftrain = open("../dataset/Beauty/local_train_sample_sorted_by_time", "w")
    ftest = open("../dataset/Beauty/local_test_sample_sorted_by_time", "w")
...
def get_all_samples():
    fin = open("../dataset/Beauty/jointed-time-new", "r")
    # ftrain = open("local_train", "w")
    ftest = open("../dataset/Beauty/local_all_sample_sorted_by_time2", "w")

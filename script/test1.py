    ...
    for line in fin:
        ...
        if clk:
            ...
            if user_history_clk_num >= 1:
                item_bhvs_feat = user + '_' + bhvs_items_str + '_' + bhvs_cats_str + '_' + cur_time
                item_his_users[item_id].append(item_bhvs_feat)
            else:
                item_bhvs_feat = user + '_' + '' + '_' + '' + '_' + cur_time
        line_idx += 1
...
def generate_voc():
    ...
    pickle.dump(uid_voc, open("../dataset/{}/uid_voc.pkl".format(dir_name), "wb"))
    pickle.dump(mid_voc, open("../dataset/{}/mid_voc.pkl".format(dir_name), "wb"))
    pickle.dump(cat_voc, open("../dataset/{}/cat_voc.pkl".format(dir_name), "wb"))
